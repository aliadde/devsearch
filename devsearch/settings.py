...
AUTH_PASSWORD_VALIDATORS = [
    ...
    # },
    # {
    #     'NAME':   'jango.contrib.auth.password_validation.NumericPasswordValidator',
    # },
]
...
# if you have your static files are not in root  
STATICFILES_DIRS = [
    BASE_DIR / 'static'
]
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'adeliali1384@gmail.com'
EMAIL_HOST_PASSWORD = 'wxnjolzwejauoyyb'
# wxnj olzw ejau oyyb 